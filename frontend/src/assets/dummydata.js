...
import BannerImage from "./CookingImg.png";
...
export const aboutfeature = [
  {
    icon: FaCalendarAlt,
    title: 'Date-wise Meal Planning',
    text: 'Admins can assign meals by date, allowing flexible menu scheduling.',
    color: 'from-amber-400 to-orange-500',
  },
  {
    icon: FaUtensils,
    title: 'Multiple Items per Meal Type',
    text: 'Easily add multiple items (e.g., rice, curry, dessert) under each meal type.',
    color: 'from-green-400 to-green-600',
  },
  {
    icon: FaPlusCircle,
    title: 'Simple Item Management',
    text: 'Add, edit, or remove menu items quickly with a clean interface.',
    color: 'from-blue-400 to-blue-600',
  },
  {
    icon: FaEye,
    title: 'Real-Time Menu Display',
    text: 'Staff see today’s meals instantly on the landing page with updates reflected live.',
